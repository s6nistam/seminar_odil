...
def main():
    ...
    parser.add_argument('--patterns', type=str, default='u_*.png,ut_*.png', 
                        help='Filename pattern (default: u_*.png,ut_*.png). Example: img_*.jpg')
    ...
    for pattern in patterns:
        args.output = output
        args.output = ".".join(args.output.split(".")[:-1]) + "_" + pattern.split("*")[0] + ".gif"
